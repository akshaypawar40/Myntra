      ...
      <Breadcrumb separator={<IoCaretForwardSharp color="gray.500" />}>
        ...
        <BreadcrumbItem>
          {step1 ? (
            ...
            <BreadcrumbLink color="gray.400">Login</BreadcrumbLink>
          )}
        </BreadcrumbItem>
        ...
        <BreadcrumbItem>
          {step2 ? (
            ...
            <BreadcrumbLink color="gray.400">Shipping</BreadcrumbLink>
          )}
        </BreadcrumbItem>
        ...
        <BreadcrumbItem>
          {step3 ? (
            ...
            <BreadcrumbLink color="gray.400">Payment</BreadcrumbLink>
          )}
        </BreadcrumbItem>
        ...
        <BreadcrumbItem>
          {step4 ? (
            ...
            <BreadcrumbLink color="gray.400">Place Order</BreadcrumbLink>
          )}
        </BreadcrumbItem>
      </Breadcrumb>
    </Flex>
